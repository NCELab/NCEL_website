...
Thank you for your interest in participating in research at the Neuro-Cognition & Emotion Lab (NCEL). Our studies explore how cognition, emotion, and brain function interact to shape behavior and mental health across development and the lifespan.
...
•	Computer-based tasks that measure attention, memory, decision-making, or emotion
•	EEG, which records brain activity using a non-invasive cap
•	MRI, which provides images of brain structure and function
